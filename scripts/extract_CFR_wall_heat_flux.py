...
INPUT_FILES = [
    ROOT / "docs/wallHeatFlux_heatTransferCFRWalls_allTimes.txt",
    ROOT / "docs/wallHeatFlux_heatTransferCFRWalls_PMS.txt",
]

OUTPUT = ROOT / "docs/results/wall_heat_flux_CFR_walls.csv"
